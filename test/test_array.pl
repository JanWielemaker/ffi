...
test(int_list, R == [3,1,0,2]) :-
    c_array_list(CPtr,[3,1,0,2]),
    c_array_list(CPtr,R).

test(float_list, R == [3.0,1.0,0.0,2.0]) :-
   c_array_list(CPtr,[3.0,1.0,0.0,2.0]),
   c_array_list(CPtr,R).
